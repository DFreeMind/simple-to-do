...
const documents = [
  ...
  },
  {
    ...
    sections: [
      ...
      { title: '本机空间管理', paragraphs: ['"个人空间 → 空间管理"按需扫描本机数据，把应用占用的每一类文件分开统计，并提供安全的附件整理流程。'], image: { src: '/screenshots/space-management.webp', alt: '空间管理与附件维护', caption: '空间管理可扫描本机附件、查看历史迁移备份和设置垃圾桶保留时间' }, items: [
        ...
        '本机恢复点：单独占一栏展示当前所有恢复点总大小，可一键跳到"数据与安全"管理',
