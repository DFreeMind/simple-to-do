...
const documents = [
  ...
  },
  {
    ...
    sections: [
      { title: '你可以管理什么', paragraphs: ['易简清单把日常安排拆成几类对象。先分清它们的作用，再决定任务放在哪里：'], image: { src: '/screenshots/sidebar.webp', alt: '应用功能入口总览', caption: '模块栏与清单侧栏共同放置应用入口、视图、清单和常用操作' }, items: [
      ...
      { title: '常用入口在哪里', paragraphs: ['桌面端打开后，最左侧是全局模块栏，清单栏、任务列表和任务详情依次展开。没有选中任务时，右侧会显示空状态；这不是额外的任务栏。'], items: [
  ...
  },
  {
    ...
    sections: [
      { title: '当前版本 v0.4.2', paragraphs: ['本版本聚焦专注成长、花田成就和桌面端体验：'], items: [
