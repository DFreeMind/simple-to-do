...
const documents = [
  ...
  },
  {
    ...
    sections: [
      { title: '在应用内更新', paragraphs: ['打开“设置 → 关于与更新”，可查看当前版本与本次更新说明。应用启动后会静默检查更新；发现新版本时，设置入口会出现提示。'], items: [
        '点击“检查更新”手动重新检查；开发环境不会请求更新服务',
        '发现可用版本后，先查看更新说明，再点击“下载并安装”',
        '可以跳过某个版本；发布更高版本后会再次提示',
        '下载完成后应用会校验更新包签名，并按平台完成安装或提示重新启动',
        '更新源可选择自动（自建优先）、自建服务器或 GitHub；网络异常不会影响本机任务数据'
